class user_profile_show_update_list extends ActionHandler
{
    ...
    ajaxSuccess(xhttp)
    {
        ...
        {
            var content="選擇欲修改餐點:<br><table border=1>\n\
            ...
            $('#submit').on('click',function(){
                (new user_profile_show_update_page('user_profile','show_update_page','show_area')).run();
            });
