...
class show_select_page implements ActionListener
{
    public function actionPerformed($event_message)
    {
        ...
        $sql="SELECT orderID,prodName,price,howmany,total,status FROM `order` WHERE username like '$username' ORDER BY orderID DESC";
        ...
        else
        {
            ...
            $return_value['status_message']='Excute Error'+$username;
